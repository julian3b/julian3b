          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  {formData.customPersonality?.length || 0}/10000
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  {formData.characters?.length || 0}/10000
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  {formData.events?.length || 0}/10000
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  {formData.scenario?.length || 0}/10000
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  {formData.places?.length || 0}/10000
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  {formData.additionalSettings?.length || 0}/10000
                </p>
              </div>
            </div>
