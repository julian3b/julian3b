...
- **November 5, 2025**: Disabled React Query auto-refetching (refetchOnMount, refetchOnWindowFocus) to prevent any stale data from overwriting optimistic updates during the session
